...
namespace SIADAL.Controllers
{
    ...
    public class TeacherController : ControllerBase
    {
        ...
        public TeacherController(ITeacher repository)
        {
        ...
        [HttpGet("")]
        [HttpGet("view_all")]
        public async Task<IActionResult> Get([FromQuery] TeacherQueryObject query)
        {
        ...
        public async Task<IActionResult> Put(ulong id, [FromBody] UpdateTeacherDTO dto)
        {
            if (!ModelState.IsValid) return BadRequest(ModelState);
