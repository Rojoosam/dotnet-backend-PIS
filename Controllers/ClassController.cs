...
namespace SIADAL.Controllers
{
    ...
    {
        private readonly IClass _repository;

        public ClassController(IClass repository)
        {
        ...
        [HttpGet("")]
        [HttpGet("view_all")]
        public async Task<IActionResult> Get([FromQuery] ClassQueryObject query)
        {
        ...
        public async Task<IActionResult> Put(ulong id, [FromBody] UpdateClassDTO dto)
        {
            if (!ModelState.IsValid) return BadRequest(ModelState);
