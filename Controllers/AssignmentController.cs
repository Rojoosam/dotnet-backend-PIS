...
namespace SIADAL.Controllers
{
    ...
    {
        private readonly IAssignment _repository;

        public AssignmentController(IAssignment repository)
        {
        ...
        [HttpGet("")]
        [HttpGet("view_all")]
        public async Task<IActionResult> Get([FromQuery] AssignmentQueryObject query)
        {
        ...
        [HttpPost("")]
        [HttpPost("create")]
        public async Task<IActionResult> Post([FromBody] CreateAssignmentDTO dto)
        {
            if (!ModelState.IsValid) return BadRequest(ModelState);
        ...
        public async Task<IActionResult> Put(int id, [FromBody] UpdateAssignmentDTO dto)
        {
            if (!ModelState.IsValid) return BadRequest(ModelState);
